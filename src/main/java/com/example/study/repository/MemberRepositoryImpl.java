...
// QueryDsl 용 인터페이스의 구현체는 반드시 끝이 lmpl로 끝나야 자동으로 인식되어서
...
public class MemberRepositoryImpl implements MemberRepositoryCustom{
   ...
   private BooleanExpression nemeEq(String nameParam) {
